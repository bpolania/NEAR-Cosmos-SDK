...
/// 
/// This module implements the 07-tendermint IBC light client specification
/// for verifying Tendermint/CometBFT consensus within the Cosmos SDK NEAR contract.
#[derive(BorshDeserialize, BorshSerialize)]
pub struct TendermintLightClientModule {
...
impl TendermintLightClientModule {
    /// Initialize the IBC Tendermint Light Client module
    pub fn new() -> Self {
        Self {
            client_states: LookupMap::new(b"i"),
            consensus_states: LookupMap::new(b"c"),
    ...
    pub fn verify_membership(
        ...
        verify_merkle_proof(&consensus_state.root, &key, Some(&value), &proof)
    }
