use near_sdk::env;
use super::types::{ClientState, ConsensusState, Header, Height, ValidatorSet};
use super::crypto::{verify_commit_signatures, sha256};
...
fn verify_validator_set_transition(
    ...
    trust_level: &super::types::Fraction,
) -> Result<(), String> {
...
fn compute_validator_bytes(validator: &super::types::Validator) -> Vec<u8> {
...
fn compute_canonical_block_bytes(header: &super::types::BlockHeader) -> Vec<u8> {
    // This is a simplified implementation
...
mod tests {
    use super::*;
    use crate::modules::ibc::client::tendermint::types::*;
