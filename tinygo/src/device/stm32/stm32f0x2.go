...
func (o *EXTI_Type) SetPR_PIF31(value uint32) {
	volatile.StoreUint32(&o.PR.Reg, volatile.LoadUint32(&o.PR.Reg)&^(0x80000000)|value<<31)
}
func (o *EXTI_Type) GetPR_PIF31() uint32 {
	return (volatile.LoadUint32(&o.PR.Reg) & 0x80000000) >> 31
}
