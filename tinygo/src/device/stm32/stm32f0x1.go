...
func (o *DBGMCU_Type) SetAPB1_FZ_TIM3_counter_stopped_when_core_is_halted(value uint32) {
	volatile.StoreUint32(&o.APB1_FZ.Reg, volatile.LoadUint32(&o.APB1_FZ.Reg)&^(0x10)|value<<4)
}
func (o *DBGMCU_Type) GetAPB1_FZ_TIM3_counter_stopped_when_core_is_halted() uint32 {
