...
// I2C.MASK0: I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
...
// I2C.MASK1: I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
...
// I2C.MASK2: I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
...
// I2C.MASK3: I2C Slave address mask register n. This mask register is associated with I2ADRn to determine an address match. The mask register has no effect when comparing to the General Call address (0000000).
...
func (o *WWDT_Type) SetMOD_RESERVED(value uint32) {
	volatile.StoreUint32(&o.MOD.Reg, volatile.LoadUint32(&o.MOD.Reg)&^(0xffffffe0)|value<<5)
}
func (o *WWDT_Type) GetMOD_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.MOD.Reg) & 0xffffffe0) >> 5
}
...
// UART.RBR: Receiver Buffer Register. Contains the next received character to be read. When DLAB=0.
...
// UART.DLM: Divisor Latch MSB. Most significant byte of the baud rate divisor value. The full divisor is used to generate a baud rate from the fractional rate divider. When DLAB=1.
...
func (o *UART_Type) SetIIR_FIFOEN(value uint32) {
	volatile.StoreUint32(&o.IIR.Reg, volatile.LoadUint32(&o.IIR.Reg)&^(0xc0)|value<<6)
}
func (o *UART_Type) GetIIR_FIFOEN() uint32 {
...
func (o *UART_Type) SetMSR_DELTADCD(value uint32) {
	volatile.StoreUint32(&o.MSR.Reg, volatile.LoadUint32(&o.MSR.Reg)&^(0x8)|value<<3)
}
func (o *UART_Type) GetMSR_DELTADCD() uint32 {
...
// CT16B0.BIR: Interrupt Register (IR). The IR can be written to clear interrupts. The IR can be read to identify which of five possible interrupt sources are pending.
func (o *CT16B0_Type) SetBIR_MR0INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x1)|value)
}
func (o *CT16B0_Type) GetBIR_MR0INT() uint32 {
	return volatile.LoadUint32(&o.BIR.Reg) & 0x1
}
func (o *CT16B0_Type) SetBIR_MR1INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x2)|value<<1)
}
func (o *CT16B0_Type) GetBIR_MR1INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x2) >> 1
}
func (o *CT16B0_Type) SetBIR_MR2INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x4)|value<<2)
}
func (o *CT16B0_Type) GetBIR_MR2INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x4) >> 2
}
func (o *CT16B0_Type) SetBIR_MR3INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x8)|value<<3)
}
func (o *CT16B0_Type) GetBIR_MR3INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x8) >> 3
}
func (o *CT16B0_Type) SetBIR_CR0INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x10)|value<<4)
}
func (o *CT16B0_Type) GetBIR_CR0INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x10) >> 4
}
func (o *CT16B0_Type) SetBIR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0xffffffe0)|value<<5)
}
func (o *CT16B0_Type) GetBIR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0xffffffe0) >> 5
}

// CT16B0.BTCR: Timer Control Register (TCR). The TCR is used to control the Timer Counter functions. The Timer Counter can be disabled or reset through the TCR.
func (o *CT16B0_Type) SetBTCR_CEN(value uint32) {
	volatile.StoreUint32(&o.BTCR.Reg, volatile.LoadUint32(&o.BTCR.Reg)&^(0x1)|value)
}
func (o *CT16B0_Type) GetBTCR_CEN() uint32 {
	return volatile.LoadUint32(&o.BTCR.Reg) & 0x1
}
func (o *CT16B0_Type) SetBTCR_CRESET(value uint32) {
	volatile.StoreUint32(&o.BTCR.Reg, volatile.LoadUint32(&o.BTCR.Reg)&^(0x2)|value<<1)
}
func (o *CT16B0_Type) GetBTCR_CRESET() uint32 {
	return (volatile.LoadUint32(&o.BTCR.Reg) & 0x2) >> 1
}
func (o *CT16B0_Type) SetBTCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BTCR.Reg, volatile.LoadUint32(&o.BTCR.Reg)&^(0xfffffffc)|value<<2)
}
func (o *CT16B0_Type) GetBTCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BTCR.Reg) & 0xfffffffc) >> 2
}

// CT16B0.BTC: Timer Counter (TC). The 16-bit TC is incremented every PR+1 cycles of PCLK. The TC is controlled through the TCR.
func (o *CT16B0_Type) SetBTC_TC(value uint32) {
	volatile.StoreUint32(&o.BTC.Reg, volatile.LoadUint32(&o.BTC.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBTC_TC() uint32 {
	return volatile.LoadUint32(&o.BTC.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBTC_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BTC.Reg, volatile.LoadUint32(&o.BTC.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBTC_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BTC.Reg) & 0xffff0000) >> 16
}

// CT16B0.BPR: Prescale Register (PR). When the Prescale Counter (below) is equal to this value, the next clock increments the TC and clears the PC.
func (o *CT16B0_Type) SetBPR_PR(value uint32) {
	volatile.StoreUint32(&o.BPR.Reg, volatile.LoadUint32(&o.BPR.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBPR_PR() uint32 {
	return volatile.LoadUint32(&o.BPR.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBPR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BPR.Reg, volatile.LoadUint32(&o.BPR.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBPR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BPR.Reg) & 0xffff0000) >> 16
}

// CT16B0.BPC: Prescale Counter (PC). The 16-bit PC is a counter which is incremented to the value stored in PR. When the value in PR is reached, the TC is incremented and the PC is cleared. The PC is observable and controllable through the bus interface.
func (o *CT16B0_Type) SetBPC_PC(value uint32) {
	volatile.StoreUint32(&o.BPC.Reg, volatile.LoadUint32(&o.BPC.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBPC_PC() uint32 {
	return volatile.LoadUint32(&o.BPC.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBPC_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BPC.Reg, volatile.LoadUint32(&o.BPC.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBPC_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BPC.Reg) & 0xffff0000) >> 16
}

// CT16B0.BMCR: Match Control Register (MCR). The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
func (o *CT16B0_Type) SetBMCR_MR0I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x1)|value)
}
func (o *CT16B0_Type) GetBMCR_MR0I() uint32 {
	return volatile.LoadUint32(&o.BMCR.Reg) & 0x1
}
func (o *CT16B0_Type) SetBMCR_MR0R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x2)|value<<1)
}
func (o *CT16B0_Type) GetBMCR_MR0R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x2) >> 1
}
func (o *CT16B0_Type) SetBMCR_MR0S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x4)|value<<2)
}
func (o *CT16B0_Type) GetBMCR_MR0S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x4) >> 2
}
func (o *CT16B0_Type) SetBMCR_MR1I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x8)|value<<3)
}
func (o *CT16B0_Type) GetBMCR_MR1I() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x8) >> 3
}
func (o *CT16B0_Type) SetBMCR_MR1R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x10)|value<<4)
}
func (o *CT16B0_Type) GetBMCR_MR1R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x10) >> 4
}
func (o *CT16B0_Type) SetBMCR_MR1S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x20)|value<<5)
}
func (o *CT16B0_Type) GetBMCR_MR1S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x20) >> 5
}
func (o *CT16B0_Type) SetBMCR_MR2I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x40)|value<<6)
}
func (o *CT16B0_Type) GetBMCR_MR2I() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x40) >> 6
}
func (o *CT16B0_Type) SetBMCR_MR2R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x80)|value<<7)
}
func (o *CT16B0_Type) GetBMCR_MR2R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x80) >> 7
}
func (o *CT16B0_Type) SetBMCR_MR2S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x100)|value<<8)
}
func (o *CT16B0_Type) GetBMCR_MR2S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x100) >> 8
}
func (o *CT16B0_Type) SetBMCR_MR3I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x200)|value<<9)
}
func (o *CT16B0_Type) GetBMCR_MR3I() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x200) >> 9
}
func (o *CT16B0_Type) SetBMCR_MR3R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x400)|value<<10)
}
func (o *CT16B0_Type) GetBMCR_MR3R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x400) >> 10
}
func (o *CT16B0_Type) SetBMCR_MR3S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x800)|value<<11)
}
func (o *CT16B0_Type) GetBMCR_MR3S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x800) >> 11
}
func (o *CT16B0_Type) SetBMCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0xfffff000)|value<<12)
}
func (o *CT16B0_Type) GetBMCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0xfffff000) >> 12
}

// CT16B0.BMR0: Match Register 0 (MR0). MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT16B0_Type) SetBMR0_MATCH(value uint32) {
	volatile.StoreUint32(&o.BMR0.Reg, volatile.LoadUint32(&o.BMR0.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBMR0_MATCH() uint32 {
	return volatile.LoadUint32(&o.BMR0.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBMR0_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BMR0.Reg, volatile.LoadUint32(&o.BMR0.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBMR0_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BMR0.Reg) & 0xffff0000) >> 16
}

// CT16B0.BMR1: Match Register 0 (MR0). MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT16B0_Type) SetBMR1_MATCH(value uint32) {
	volatile.StoreUint32(&o.BMR1.Reg, volatile.LoadUint32(&o.BMR1.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBMR1_MATCH() uint32 {
	return volatile.LoadUint32(&o.BMR1.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBMR1_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BMR1.Reg, volatile.LoadUint32(&o.BMR1.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBMR1_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BMR1.Reg) & 0xffff0000) >> 16
}

// CT16B0.BMR2: Match Register 0 (MR0). MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT16B0_Type) SetBMR2_MATCH(value uint32) {
	volatile.StoreUint32(&o.BMR2.Reg, volatile.LoadUint32(&o.BMR2.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBMR2_MATCH() uint32 {
	return volatile.LoadUint32(&o.BMR2.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBMR2_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BMR2.Reg, volatile.LoadUint32(&o.BMR2.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBMR2_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BMR2.Reg) & 0xffff0000) >> 16
}

// CT16B0.BMR3: Match Register 0 (MR0). MR0 can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT16B0_Type) SetBMR3_MATCH(value uint32) {
	volatile.StoreUint32(&o.BMR3.Reg, volatile.LoadUint32(&o.BMR3.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBMR3_MATCH() uint32 {
	return volatile.LoadUint32(&o.BMR3.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBMR3_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BMR3.Reg, volatile.LoadUint32(&o.BMR3.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBMR3_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BMR3.Reg) & 0xffff0000) >> 16
}

// CT16B0.BCCR: Capture Control Register (CCR). The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
func (o *CT16B0_Type) SetBCCR_CAP0RE(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0x1)|value)
}
func (o *CT16B0_Type) GetBCCR_CAP0RE() uint32 {
	return volatile.LoadUint32(&o.BCCR.Reg) & 0x1
}
func (o *CT16B0_Type) SetBCCR_CAP0FE(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0x2)|value<<1)
}
func (o *CT16B0_Type) GetBCCR_CAP0FE() uint32 {
	return (volatile.LoadUint32(&o.BCCR.Reg) & 0x2) >> 1
}
func (o *CT16B0_Type) SetBCCR_CAP0I(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0x4)|value<<2)
}
func (o *CT16B0_Type) GetBCCR_CAP0I() uint32 {
	return (volatile.LoadUint32(&o.BCCR.Reg) & 0x4) >> 2
}
func (o *CT16B0_Type) SetBCCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0xfffffff8)|value<<3)
}
func (o *CT16B0_Type) GetBCCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BCCR.Reg) & 0xfffffff8) >> 3
}

// CT16B0.BCR0: Capture Register 0 (CR0). CR0 is loaded with the value of TC when there is an event on the CT16B0_CAP0 input.
func (o *CT16B0_Type) SetBCR0_CAP(value uint32) {
	volatile.StoreUint32(&o.BCR0.Reg, volatile.LoadUint32(&o.BCR0.Reg)&^(0xffff)|value)
}
func (o *CT16B0_Type) GetBCR0_CAP() uint32 {
	return volatile.LoadUint32(&o.BCR0.Reg) & 0xffff
}
func (o *CT16B0_Type) SetBCR0_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BCR0.Reg, volatile.LoadUint32(&o.BCR0.Reg)&^(0xffff0000)|value<<16)
}
func (o *CT16B0_Type) GetBCR0_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BCR0.Reg) & 0xffff0000) >> 16
}

// CT16B0.BEMR: External Match Register (EMR). The EMR controls the match function and the external match pins CT16B0_MAT[2:0].
func (o *CT16B0_Type) SetBEMR_EM0(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x1)|value)
}
func (o *CT16B0_Type) GetBEMR_EM0() uint32 {
	return volatile.LoadUint32(&o.BEMR.Reg) & 0x1
}
func (o *CT16B0_Type) SetBEMR_EM1(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x2)|value<<1)
}
func (o *CT16B0_Type) GetBEMR_EM1() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x2) >> 1
}
func (o *CT16B0_Type) SetBEMR_EM2(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x4)|value<<2)
}
func (o *CT16B0_Type) GetBEMR_EM2() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x4) >> 2
}
func (o *CT16B0_Type) SetBEMR_EM3(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x8)|value<<3)
}
func (o *CT16B0_Type) GetBEMR_EM3() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x8) >> 3
}
func (o *CT16B0_Type) SetBEMR_EMC0(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x30)|value<<4)
}
func (o *CT16B0_Type) GetBEMR_EMC0() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x30) >> 4
}
func (o *CT16B0_Type) SetBEMR_EMC1(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0xc0)|value<<6)
}
func (o *CT16B0_Type) GetBEMR_EMC1() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0xc0) >> 6
}
func (o *CT16B0_Type) SetBEMR_EMC2(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x300)|value<<8)
}
func (o *CT16B0_Type) GetBEMR_EMC2() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x300) >> 8
}
func (o *CT16B0_Type) SetBEMR_EMC3(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0xc00)|value<<10)
}
func (o *CT16B0_Type) GetBEMR_EMC3() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0xc00) >> 10
}
func (o *CT16B0_Type) SetBEMR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0xfffff000)|value<<12)
}
func (o *CT16B0_Type) GetBEMR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0xfffff000) >> 12
}

// CT16B0.BCTCR: Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
func (o *CT16B0_Type) SetBCTCR_CTM(value uint32) {
	volatile.StoreUint32(&o.BCTCR.Reg, volatile.LoadUint32(&o.BCTCR.Reg)&^(0x3)|value)
}
func (o *CT16B0_Type) GetBCTCR_CTM() uint32 {
	return volatile.LoadUint32(&o.BCTCR.Reg) & 0x3
}
func (o *CT16B0_Type) SetBCTCR_CIS(value uint32) {
	volatile.StoreUint32(&o.BCTCR.Reg, volatile.LoadUint32(&o.BCTCR.Reg)&^(0xc)|value<<2)
}
func (o *CT16B0_Type) GetBCTCR_CIS() uint32 {
	return (volatile.LoadUint32(&o.BCTCR.Reg) & 0xc) >> 2
}
func (o *CT16B0_Type) SetBCTCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BCTCR.Reg, volatile.LoadUint32(&o.BCTCR.Reg)&^(0xfffffff0)|value<<4)
}
func (o *CT16B0_Type) GetBCTCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BCTCR.Reg) & 0xfffffff0) >> 4
}

// CT16B0.BPWMC: PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT16B0_MAT[2:0].
func (o *CT16B0_Type) SetBPWMC_PWMEN0(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x1)|value)
}
func (o *CT16B0_Type) GetBPWMC_PWMEN0() uint32 {
	return volatile.LoadUint32(&o.BPWMC.Reg) & 0x1
}
func (o *CT16B0_Type) SetBPWMC_PWMEN1(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x2)|value<<1)
}
func (o *CT16B0_Type) GetBPWMC_PWMEN1() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0x2) >> 1
}
func (o *CT16B0_Type) SetBPWMC_PWMEN2(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x4)|value<<2)
}
func (o *CT16B0_Type) GetBPWMC_PWMEN2() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0x4) >> 2
}
func (o *CT16B0_Type) SetBPWMC_PWMEN3(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x8)|value<<3)
}
func (o *CT16B0_Type) GetBPWMC_PWMEN3() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0x8) >> 3
}
func (o *CT16B0_Type) SetBPWMC_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0xfffffff0)|value<<4)
}
func (o *CT16B0_Type) GetBPWMC_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0xfffffff0) >> 4
}
...
// CT32B0.BIR: Interrupt Register (IR). The IR can be written to clear interrupts. The IR can be read to identify which of five possible interrupt sources are pending.
func (o *CT32B0_Type) SetBIR_MR0INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x1)|value)
}
func (o *CT32B0_Type) GetBIR_MR0INT() uint32 {
	return volatile.LoadUint32(&o.BIR.Reg) & 0x1
}
func (o *CT32B0_Type) SetBIR_MR1INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x2)|value<<1)
}
func (o *CT32B0_Type) GetBIR_MR1INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x2) >> 1
}
func (o *CT32B0_Type) SetBIR_MR2INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x4)|value<<2)
}
func (o *CT32B0_Type) GetBIR_MR2INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x4) >> 2
}
func (o *CT32B0_Type) SetBIR_MR3INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x8)|value<<3)
}
func (o *CT32B0_Type) GetBIR_MR3INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x8) >> 3
}
func (o *CT32B0_Type) SetBIR_CR0INT(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0x10)|value<<4)
}
func (o *CT32B0_Type) GetBIR_CR0INT() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0x10) >> 4
}
func (o *CT32B0_Type) SetBIR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BIR.Reg, volatile.LoadUint32(&o.BIR.Reg)&^(0xffffffe0)|value<<5)
}
func (o *CT32B0_Type) GetBIR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BIR.Reg) & 0xffffffe0) >> 5
}

// CT32B0.BTCR: Timer Control Register (TCR). The TCR is used to control the Timer Counter functions. The Timer Counter can be disabled or reset through the TCR.
func (o *CT32B0_Type) SetBTCR_CEN(value uint32) {
	volatile.StoreUint32(&o.BTCR.Reg, volatile.LoadUint32(&o.BTCR.Reg)&^(0x1)|value)
}
func (o *CT32B0_Type) GetBTCR_CEN() uint32 {
	return volatile.LoadUint32(&o.BTCR.Reg) & 0x1
}
func (o *CT32B0_Type) SetBTCR_CRES(value uint32) {
	volatile.StoreUint32(&o.BTCR.Reg, volatile.LoadUint32(&o.BTCR.Reg)&^(0x2)|value<<1)
}
func (o *CT32B0_Type) GetBTCR_CRES() uint32 {
	return (volatile.LoadUint32(&o.BTCR.Reg) & 0x2) >> 1
}
func (o *CT32B0_Type) SetBTCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BTCR.Reg, volatile.LoadUint32(&o.BTCR.Reg)&^(0xfffffffc)|value<<2)
}
func (o *CT32B0_Type) GetBTCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BTCR.Reg) & 0xfffffffc) >> 2
}

// CT32B0.BTC: Timer Counter (TC). The 32-bit TC is incremented every PR+1 cycles of PCLK. The TC is controlled through the TCR.
func (o *CT32B0_Type) SetBTC(value uint32) {
	volatile.StoreUint32(&o.BTC.Reg, value)
}
func (o *CT32B0_Type) GetBTC() uint32 {
	return volatile.LoadUint32(&o.BTC.Reg)
}

// CT32B0.BPR: Prescale Register (PR). When the Prescale Counter (below) is equal to this value, the next clock increments the TC and clears the PC.
func (o *CT32B0_Type) SetBPR(value uint32) {
	volatile.StoreUint32(&o.BPR.Reg, value)
}
func (o *CT32B0_Type) GetBPR() uint32 {
	return volatile.LoadUint32(&o.BPR.Reg)
}

// CT32B0.BPC: Prescale Counter (PC). The 32-bit PC is a counter which is incremented to the value stored in PR. When the value in PR is reached, the TC is incremented and the PC is cleared. The PC is observable and controllable through the bus interface.
func (o *CT32B0_Type) SetBPC(value uint32) {
	volatile.StoreUint32(&o.BPC.Reg, value)
}
func (o *CT32B0_Type) GetBPC() uint32 {
	return volatile.LoadUint32(&o.BPC.Reg)
}

// CT32B0.BMCR: Match Control Register (MCR). The MCR is used to control if an interrupt is generated and if the TC is reset when a Match occurs.
func (o *CT32B0_Type) SetBMCR_MR0I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x1)|value)
}
func (o *CT32B0_Type) GetBMCR_MR0I() uint32 {
	return volatile.LoadUint32(&o.BMCR.Reg) & 0x1
}
func (o *CT32B0_Type) SetBMCR_MR0R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x2)|value<<1)
}
func (o *CT32B0_Type) GetBMCR_MR0R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x2) >> 1
}
func (o *CT32B0_Type) SetBMCR_MR0S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x4)|value<<2)
}
func (o *CT32B0_Type) GetBMCR_MR0S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x4) >> 2
}
func (o *CT32B0_Type) SetBMCR_MR1I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x8)|value<<3)
}
func (o *CT32B0_Type) GetBMCR_MR1I() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x8) >> 3
}
func (o *CT32B0_Type) SetBMCR_MR1R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x10)|value<<4)
}
func (o *CT32B0_Type) GetBMCR_MR1R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x10) >> 4
}
func (o *CT32B0_Type) SetBMCR_MR1S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x20)|value<<5)
}
func (o *CT32B0_Type) GetBMCR_MR1S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x20) >> 5
}
func (o *CT32B0_Type) SetBMCR_MR2I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x40)|value<<6)
}
func (o *CT32B0_Type) GetBMCR_MR2I() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x40) >> 6
}
func (o *CT32B0_Type) SetBMCR_MR2R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x80)|value<<7)
}
func (o *CT32B0_Type) GetBMCR_MR2R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x80) >> 7
}
func (o *CT32B0_Type) SetBMCR_MR2S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x100)|value<<8)
}
func (o *CT32B0_Type) GetBMCR_MR2S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x100) >> 8
}
func (o *CT32B0_Type) SetBMCR_MR3I(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x200)|value<<9)
}
func (o *CT32B0_Type) GetBMCR_MR3I() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x200) >> 9
}
func (o *CT32B0_Type) SetBMCR_MR3R(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x400)|value<<10)
}
func (o *CT32B0_Type) GetBMCR_MR3R() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x400) >> 10
}
func (o *CT32B0_Type) SetBMCR_MR3S(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0x800)|value<<11)
}
func (o *CT32B0_Type) GetBMCR_MR3S() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0x800) >> 11
}
func (o *CT32B0_Type) SetBMCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BMCR.Reg, volatile.LoadUint32(&o.BMCR.Reg)&^(0xfffff000)|value<<12)
}
func (o *CT32B0_Type) GetBMCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BMCR.Reg) & 0xfffff000) >> 12
}

// CT32B0.BMR0: Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT32B0_Type) SetBMR0(value uint32) {
	volatile.StoreUint32(&o.BMR0.Reg, value)
}
func (o *CT32B0_Type) GetBMR0() uint32 {
	return volatile.LoadUint32(&o.BMR0.Reg)
}

// CT32B0.BMR1: Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT32B0_Type) SetBMR1(value uint32) {
	volatile.StoreUint32(&o.BMR1.Reg, value)
}
func (o *CT32B0_Type) GetBMR1() uint32 {
	return volatile.LoadUint32(&o.BMR1.Reg)
}

// CT32B0.BMR2: Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT32B0_Type) SetBMR2(value uint32) {
	volatile.StoreUint32(&o.BMR2.Reg, value)
}
func (o *CT32B0_Type) GetBMR2() uint32 {
	return volatile.LoadUint32(&o.BMR2.Reg)
}

// CT32B0.BMR3: Match Register. MR can be enabled through the MCR to reset the TC, stop both the TC and PC, and/or generate an interrupt every time MR0 matches the TC.
func (o *CT32B0_Type) SetBMR3(value uint32) {
	volatile.StoreUint32(&o.BMR3.Reg, value)
}
func (o *CT32B0_Type) GetBMR3() uint32 {
	return volatile.LoadUint32(&o.BMR3.Reg)
}

// CT32B0.BCCR: Capture Control Register (CCR). The CCR controls which edges of the capture inputs are used to load the Capture Registers and whether or not an interrupt is generated when a capture takes place.
func (o *CT32B0_Type) SetBCCR_CAP0RE(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0x1)|value)
}
func (o *CT32B0_Type) GetBCCR_CAP0RE() uint32 {
	return volatile.LoadUint32(&o.BCCR.Reg) & 0x1
}
func (o *CT32B0_Type) SetBCCR_CAP0FE(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0x2)|value<<1)
}
func (o *CT32B0_Type) GetBCCR_CAP0FE() uint32 {
	return (volatile.LoadUint32(&o.BCCR.Reg) & 0x2) >> 1
}
func (o *CT32B0_Type) SetBCCR_CAP0I(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0x4)|value<<2)
}
func (o *CT32B0_Type) GetBCCR_CAP0I() uint32 {
	return (volatile.LoadUint32(&o.BCCR.Reg) & 0x4) >> 2
}
func (o *CT32B0_Type) SetBCCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BCCR.Reg, volatile.LoadUint32(&o.BCCR.Reg)&^(0xfffffff8)|value<<3)
}
func (o *CT32B0_Type) GetBCCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BCCR.Reg) & 0xfffffff8) >> 3
}

// CT32B0.BCR0: Capture Register 0 (CR0). CR0 is loaded with the value of TC when there is an event on the CT32B0_CAP0 input.
func (o *CT32B0_Type) SetBCR0(value uint32) {
	volatile.StoreUint32(&o.BCR0.Reg, value)
}
func (o *CT32B0_Type) GetBCR0() uint32 {
	return volatile.LoadUint32(&o.BCR0.Reg)
}

// CT32B0.BEMR: External Match Register (EMR). The EMR controls the match function and the external match pins CT32B0_MAT[3:0].
func (o *CT32B0_Type) SetBEMR_EM0(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x1)|value)
}
func (o *CT32B0_Type) GetBEMR_EM0() uint32 {
	return volatile.LoadUint32(&o.BEMR.Reg) & 0x1
}
func (o *CT32B0_Type) SetBEMR_EM1(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x2)|value<<1)
}
func (o *CT32B0_Type) GetBEMR_EM1() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x2) >> 1
}
func (o *CT32B0_Type) SetBEMR_EM2(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x4)|value<<2)
}
func (o *CT32B0_Type) GetBEMR_EM2() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x4) >> 2
}
func (o *CT32B0_Type) SetBEMR_EM3(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x8)|value<<3)
}
func (o *CT32B0_Type) GetBEMR_EM3() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x8) >> 3
}
func (o *CT32B0_Type) SetBEMR_EMC0(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x30)|value<<4)
}
func (o *CT32B0_Type) GetBEMR_EMC0() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x30) >> 4
}
func (o *CT32B0_Type) SetBEMR_EMC1(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0xc0)|value<<6)
}
func (o *CT32B0_Type) GetBEMR_EMC1() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0xc0) >> 6
}
func (o *CT32B0_Type) SetBEMR_EMC2(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0x300)|value<<8)
}
func (o *CT32B0_Type) GetBEMR_EMC2() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0x300) >> 8
}
func (o *CT32B0_Type) SetBEMR_EMC3(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0xc00)|value<<10)
}
func (o *CT32B0_Type) GetBEMR_EMC3() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0xc00) >> 10
}
func (o *CT32B0_Type) SetBEMR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BEMR.Reg, volatile.LoadUint32(&o.BEMR.Reg)&^(0xfffff000)|value<<12)
}
func (o *CT32B0_Type) GetBEMR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BEMR.Reg) & 0xfffff000) >> 12
}

// CT32B0.BCTCR: Count Control Register (CTCR). The CTCR selects between Timer and Counter mode, and in Counter mode selects the signal and edge(s) for counting.
func (o *CT32B0_Type) SetBCTCR_CTM(value uint32) {
	volatile.StoreUint32(&o.BCTCR.Reg, volatile.LoadUint32(&o.BCTCR.Reg)&^(0x3)|value)
}
func (o *CT32B0_Type) GetBCTCR_CTM() uint32 {
	return volatile.LoadUint32(&o.BCTCR.Reg) & 0x3
}
func (o *CT32B0_Type) SetBCTCR_CIS(value uint32) {
	volatile.StoreUint32(&o.BCTCR.Reg, volatile.LoadUint32(&o.BCTCR.Reg)&^(0xc)|value<<2)
}
func (o *CT32B0_Type) GetBCTCR_CIS() uint32 {
	return (volatile.LoadUint32(&o.BCTCR.Reg) & 0xc) >> 2
}
func (o *CT32B0_Type) SetBCTCR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BCTCR.Reg, volatile.LoadUint32(&o.BCTCR.Reg)&^(0xfffffff0)|value<<4)
}
func (o *CT32B0_Type) GetBCTCR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BCTCR.Reg) & 0xfffffff0) >> 4
}

// CT32B0.BPWMC: PWM Control Register (PWMCON). The PWMCON enables PWM mode for the external match pins CT32B0_MAT[3:0].
func (o *CT32B0_Type) SetBPWMC_PWMEN0(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x1)|value)
}
func (o *CT32B0_Type) GetBPWMC_PWMEN0() uint32 {
	return volatile.LoadUint32(&o.BPWMC.Reg) & 0x1
}
func (o *CT32B0_Type) SetBPWMC_PWMEN1(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x2)|value<<1)
}
func (o *CT32B0_Type) GetBPWMC_PWMEN1() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0x2) >> 1
}
func (o *CT32B0_Type) SetBPWMC_PWMEN2(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x4)|value<<2)
}
func (o *CT32B0_Type) GetBPWMC_PWMEN2() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0x4) >> 2
}
func (o *CT32B0_Type) SetBPWMC_PWMEN3(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0x8)|value<<3)
}
func (o *CT32B0_Type) GetBPWMC_PWMEN3() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0x8) >> 3
}
func (o *CT32B0_Type) SetBPWMC_RESERVED(value uint32) {
	volatile.StoreUint32(&o.BPWMC.Reg, volatile.LoadUint32(&o.BPWMC.Reg)&^(0xfffffff0)|value<<4)
}
func (o *CT32B0_Type) GetBPWMC_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.BPWMC.Reg) & 0xfffffff0) >> 4
}
...
func (o *USB_Type) SetDEVINTST_CC_EMPTY(value uint32) {
	volatile.StoreUint32(&o.DEVINTST.Reg, volatile.LoadUint32(&o.DEVINTST.Reg)&^(0x400)|value<<10)
}
func (o *USB_Type) GetDEVINTST_CC_EMPTY() uint32 {
	return (volatile.LoadUint32(&o.DEVINTST.Reg) & 0x400) >> 10
}
func (o *USB_Type) SetDEVINTST_CD_FULL(value uint32) {
	volatile.StoreUint32(&o.DEVINTST.Reg, volatile.LoadUint32(&o.DEVINTST.Reg)&^(0x800)|value<<11)
}
func (o *USB_Type) GetDEVINTST_CD_FULL() uint32 {
	return (volatile.LoadUint32(&o.DEVINTST.Reg) & 0x800) >> 11
}
func (o *USB_Type) SetDEVINTST_RxENDPKT(value uint32) {
	volatile.StoreUint32(&o.DEVINTST.Reg, volatile.LoadUint32(&o.DEVINTST.Reg)&^(0x1000)|value<<12)
}
func (o *USB_Type) GetDEVINTST_RxENDPKT() uint32 {
	return (volatile.LoadUint32(&o.DEVINTST.Reg) & 0x1000) >> 12
}
func (o *USB_Type) SetDEVINTST_TxENDPKT(value uint32) {
	volatile.StoreUint32(&o.DEVINTST.Reg, volatile.LoadUint32(&o.DEVINTST.Reg)&^(0x2000)|value<<13)
}
func (o *USB_Type) GetDEVINTST_TxENDPKT() uint32 {
	return (volatile.LoadUint32(&o.DEVINTST.Reg) & 0x2000) >> 13
}
func (o *USB_Type) SetDEVINTST_RESERVED(value uint32) {
	volatile.StoreUint32(&o.DEVINTST.Reg, volatile.LoadUint32(&o.DEVINTST.Reg)&^(0xffffc000)|value<<14)
}
func (o *USB_Type) GetDEVINTST_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.DEVINTST.Reg) & 0xffffc000) >> 14
}

// USB.DEVINTEN: USB Device Interrupt Enable
func (o *USB_Type) SetDEVINTEN_FRAME_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x1)|value)
}
func (o *USB_Type) GetDEVINTEN_FRAME_EN() uint32 {
	return volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x1
}
func (o *USB_Type) SetDEVINTEN_EP0_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x2)|value<<1)
}
func (o *USB_Type) GetDEVINTEN_EP0_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x2) >> 1
}
func (o *USB_Type) SetDEVINTEN_EP1_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x4)|value<<2)
}
func (o *USB_Type) GetDEVINTEN_EP1_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x4) >> 2
}
func (o *USB_Type) SetDEVINTEN_EP2_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x8)|value<<3)
}
func (o *USB_Type) GetDEVINTEN_EP2_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x8) >> 3
}
func (o *USB_Type) SetDEVINTEN_EP3_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x10)|value<<4)
}
func (o *USB_Type) GetDEVINTEN_EP3_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x10) >> 4
}
func (o *USB_Type) SetDEVINTEN_EP4_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x20)|value<<5)
}
func (o *USB_Type) GetDEVINTEN_EP4_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x20) >> 5
}
func (o *USB_Type) SetDEVINTEN_EP5_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x40)|value<<6)
}
func (o *USB_Type) GetDEVINTEN_EP5_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x40) >> 6
}
func (o *USB_Type) SetDEVINTEN_EP6_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x80)|value<<7)
}
func (o *USB_Type) GetDEVINTEN_EP6_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x80) >> 7
}
func (o *USB_Type) SetDEVINTEN_EP7_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x100)|value<<8)
}
func (o *USB_Type) GetDEVINTEN_EP7_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x100) >> 8
}
func (o *USB_Type) SetDEVINTEN_DEV_STAT_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x200)|value<<9)
}
func (o *USB_Type) GetDEVINTEN_DEV_STAT_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x200) >> 9
}
func (o *USB_Type) SetDEVINTEN_CC_EMPTY_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x400)|value<<10)
}
func (o *USB_Type) GetDEVINTEN_CC_EMPTY_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x400) >> 10
}
func (o *USB_Type) SetDEVINTEN_CD_FULL_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x800)|value<<11)
}
func (o *USB_Type) GetDEVINTEN_CD_FULL_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x800) >> 11
}
func (o *USB_Type) SetDEVINTEN_RXENDPKT_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x1000)|value<<12)
}
func (o *USB_Type) GetDEVINTEN_RXENDPKT_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x1000) >> 12
}
func (o *USB_Type) SetDEVINTEN_TXENDPKT_EN(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0x2000)|value<<13)
}
func (o *USB_Type) GetDEVINTEN_TXENDPKT_EN() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0x2000) >> 13
}
func (o *USB_Type) SetDEVINTEN_RESERVED(value uint32) {
	volatile.StoreUint32(&o.DEVINTEN.Reg, volatile.LoadUint32(&o.DEVINTEN.Reg)&^(0xffffc000)|value<<14)
}
func (o *USB_Type) GetDEVINTEN_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.DEVINTEN.Reg) & 0xffffc000) >> 14
}

// USB.DEVINTCTRL: USB Device Interrupt Clear
func (o *USB_Type) SetDEVINTCTRL_FRAME_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x1)|value)
}
func (o *USB_Type) GetDEVINTCTRL_FRAME_CLR() uint32 {
	return volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x1
}
func (o *USB_Type) SetDEVINTCTRL_EP0_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x2)|value<<1)
}
func (o *USB_Type) GetDEVINTCTRL_EP0_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x2) >> 1
}
func (o *USB_Type) SetDEVINTCTRL_EP1_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x4)|value<<2)
}
func (o *USB_Type) GetDEVINTCTRL_EP1_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x4) >> 2
}
func (o *USB_Type) SetDEVINTCTRL_EP2_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x8)|value<<3)
}
func (o *USB_Type) GetDEVINTCTRL_EP2_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x8) >> 3
}
func (o *USB_Type) SetDEVINTCTRL_EP3_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x10)|value<<4)
}
func (o *USB_Type) GetDEVINTCTRL_EP3_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x10) >> 4
}
func (o *USB_Type) SetDEVINTCTRL_EP4_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x20)|value<<5)
}
func (o *USB_Type) GetDEVINTCTRL_EP4_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x20) >> 5
}
func (o *USB_Type) SetDEVINTCTRL_EP5_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x40)|value<<6)
}
func (o *USB_Type) GetDEVINTCTRL_EP5_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x40) >> 6
}
func (o *USB_Type) SetDEVINTCTRL_EP6_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x80)|value<<7)
}
func (o *USB_Type) GetDEVINTCTRL_EP6_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x80) >> 7
}
func (o *USB_Type) SetDEVINTCTRL_EP7_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x100)|value<<8)
}
func (o *USB_Type) GetDEVINTCTRL_EP7_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x100) >> 8
}
func (o *USB_Type) SetDEVINTCTRL_DEV_STAT_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x200)|value<<9)
}
func (o *USB_Type) GetDEVINTCTRL_DEV_STAT_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x200) >> 9
}
func (o *USB_Type) SetDEVINTCTRL_CC_EMPTY_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x400)|value<<10)
}
func (o *USB_Type) GetDEVINTCTRL_CC_EMPTY_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x400) >> 10
}
func (o *USB_Type) SetDEVINTCTRL_CD_FULL_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x800)|value<<11)
}
func (o *USB_Type) GetDEVINTCTRL_CD_FULL_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x800) >> 11
}
func (o *USB_Type) SetDEVINTCTRL_RXENDPKT_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x1000)|value<<12)
}
func (o *USB_Type) GetDEVINTCTRL_RXENDPKT_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x1000) >> 12
}
func (o *USB_Type) SetDEVINTCTRL_TXENDPKT_CLR(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0x2000)|value<<13)
}
func (o *USB_Type) GetDEVINTCTRL_TXENDPKT_CLR() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0x2000) >> 13
}
func (o *USB_Type) SetDEVINTCTRL_RESERVED(value uint32) {
	volatile.StoreUint32(&o.DEVINTCTRL.Reg, volatile.LoadUint32(&o.DEVINTCTRL.Reg)&^(0xffffc000)|value<<14)
}
func (o *USB_Type) GetDEVINTCTRL_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.DEVINTCTRL.Reg) & 0xffffc000) >> 14
}

// USB.DEVINTSET: USB Device Interrupt Set
func (o *USB_Type) SetDEVINTSET_FRAME_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x1)|value)
}
func (o *USB_Type) GetDEVINTSET_FRAME_SET() uint32 {
	return volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x1
}
func (o *USB_Type) SetDEVINTSET_EP0_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x2)|value<<1)
}
func (o *USB_Type) GetDEVINTSET_EP0_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x2) >> 1
}
func (o *USB_Type) SetDEVINTSET_EP1_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x4)|value<<2)
}
func (o *USB_Type) GetDEVINTSET_EP1_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x4) >> 2
}
func (o *USB_Type) SetDEVINTSET_EP2_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x8)|value<<3)
}
func (o *USB_Type) GetDEVINTSET_EP2_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x8) >> 3
}
func (o *USB_Type) SetDEVINTSET_EP3_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x10)|value<<4)
}
func (o *USB_Type) GetDEVINTSET_EP3_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x10) >> 4
}
func (o *USB_Type) SetDEVINTSET_EP4_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x20)|value<<5)
}
func (o *USB_Type) GetDEVINTSET_EP4_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x20) >> 5
}
func (o *USB_Type) SetDEVINTSET_EP5_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x40)|value<<6)
}
func (o *USB_Type) GetDEVINTSET_EP5_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x40) >> 6
}
func (o *USB_Type) SetDEVINTSET_EP6_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x80)|value<<7)
}
func (o *USB_Type) GetDEVINTSET_EP6_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x80) >> 7
}
func (o *USB_Type) SetDEVINTSET_EP7_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x100)|value<<8)
}
func (o *USB_Type) GetDEVINTSET_EP7_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x100) >> 8
}
func (o *USB_Type) SetDEVINTSET_DEV_STAT_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x200)|value<<9)
}
func (o *USB_Type) GetDEVINTSET_DEV_STAT_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x200) >> 9
}
func (o *USB_Type) SetDEVINTSET_CC_EMPTY_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x400)|value<<10)
}
func (o *USB_Type) GetDEVINTSET_CC_EMPTY_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x400) >> 10
}
func (o *USB_Type) SetDEVINTSET_CD_FULL_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x800)|value<<11)
}
func (o *USB_Type) GetDEVINTSET_CD_FULL_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x800) >> 11
}
func (o *USB_Type) SetDEVINTSET_RXENDPKT_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x1000)|value<<12)
}
func (o *USB_Type) GetDEVINTSET_RXENDPKT_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x1000) >> 12
}
func (o *USB_Type) SetDEVINTSET_TXENDPKT_SET(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0x2000)|value<<13)
}
func (o *USB_Type) GetDEVINTSET_TXENDPKT_SET() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0x2000) >> 13
}
func (o *USB_Type) SetDEVINTSET_RESERVED(value uint32) {
	volatile.StoreUint32(&o.DEVINTSET.Reg, volatile.LoadUint32(&o.DEVINTSET.Reg)&^(0xffffc000)|value<<14)
}
func (o *USB_Type) GetDEVINTSET_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.DEVINTSET.Reg) & 0xffffc000) >> 14
}
...
func (o *USB_Type) SetCMDCODE_CODE_WDATA(value uint32) {
	volatile.StoreUint32(&o.CMDCODE.Reg, volatile.LoadUint32(&o.CMDCODE.Reg)&^(0xff0000)|value<<16)
}
func (o *USB_Type) GetCMDCODE_CODE_WDATA() uint32 {
...
func (o *USB_Type) SetRXPLEN_RESERVED(value uint32) {
	volatile.StoreUint32(&o.RXPLEN.Reg, volatile.LoadUint32(&o.RXPLEN.Reg)&^(0xfffff800)|value<<11)
}
func (o *USB_Type) GetRXPLEN_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.RXPLEN.Reg) & 0xfffff800) >> 11
}

// USB.TXPLENn: USB Transmit Packet Length
func (o *USB_Type) SetTXPLENn_PKT_LNGTH(value uint32) {
	volatile.StoreUint32(&o.TXPLENn.Reg, volatile.LoadUint32(&o.TXPLENn.Reg)&^(0x3ff)|value)
}
func (o *USB_Type) GetTXPLENn_PKT_LNGTH() uint32 {
	return volatile.LoadUint32(&o.TXPLENn.Reg) & 0x3ff
}
func (o *USB_Type) SetTXPLENn_RESERVED(value uint32) {
	volatile.StoreUint32(&o.TXPLENn.Reg, volatile.LoadUint32(&o.TXPLENn.Reg)&^(0xfffffc00)|value<<10)
}
func (o *USB_Type) GetTXPLENn_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.TXPLENn.Reg) & 0xfffffc00) >> 10
}
...
// USB.DEVFIQSEL: USB Device FIQ select
func (o *USB_Type) SetDEVFIQSEL_FRAME(value uint32) {
	volatile.StoreUint32(&o.DEVFIQSEL.Reg, volatile.LoadUint32(&o.DEVFIQSEL.Reg)&^(0x1)|value)
}
func (o *USB_Type) GetDEVFIQSEL_FRAME() uint32 {
	return volatile.LoadUint32(&o.DEVFIQSEL.Reg) & 0x1
}
func (o *USB_Type) SetDEVFIQSEL_BULKOUT(value uint32) {
	volatile.StoreUint32(&o.DEVFIQSEL.Reg, volatile.LoadUint32(&o.DEVFIQSEL.Reg)&^(0x2)|value<<1)
}
func (o *USB_Type) GetDEVFIQSEL_BULKOUT() uint32 {
	return (volatile.LoadUint32(&o.DEVFIQSEL.Reg) & 0x2) >> 1
}
func (o *USB_Type) SetDEVFIQSEL_BULKIN(value uint32) {
	volatile.StoreUint32(&o.DEVFIQSEL.Reg, volatile.LoadUint32(&o.DEVFIQSEL.Reg)&^(0x4)|value<<2)
}
func (o *USB_Type) GetDEVFIQSEL_BULKIN() uint32 {
	return (volatile.LoadUint32(&o.DEVFIQSEL.Reg) & 0x4) >> 2
}
func (o *USB_Type) SetDEVFIQSEL_RESERVED(value uint32) {
	volatile.StoreUint32(&o.DEVFIQSEL.Reg, volatile.LoadUint32(&o.DEVFIQSEL.Reg)&^(0xfffffff8)|value<<3)
}
func (o *USB_Type) GetDEVFIQSEL_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.DEVFIQSEL.Reg) & 0xfffffff8) >> 3
}
...
// FMC.FMSTATCLR: Signature generation status clear register
func (o *FMC_Type) SetFMSTATCLR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.FMSTATCLR.Reg, volatile.LoadUint32(&o.FMSTATCLR.Reg)&^(0x3)|value)
}
func (o *FMC_Type) GetFMSTATCLR_RESERVED() uint32 {
	return volatile.LoadUint32(&o.FMSTATCLR.Reg) & 0x3
}
func (o *FMC_Type) SetFMSTATCLR_SIG_DONE_CLR(value uint32) {
	volatile.StoreUint32(&o.FMSTATCLR.Reg, volatile.LoadUint32(&o.FMSTATCLR.Reg)&^(0x4)|value<<2)
}
func (o *FMC_Type) GetFMSTATCLR_SIG_DONE_CLR() uint32 {
...
// IOCON.PIO0_1: I/O configuration for pin PIO0_1/CLKOUT/ CT32B0_MAT2/USB_FTOGGLE
...
// IOCON.PIO0_3: I/O configuration for pin PIO0_3/USB_VBUS
...
// IOCON.PIO0_6: I/O configuration for pin PIO0_6/USB_CONNECT/SCK
...
// IOCON.PIO0_9: I/O configuration for pin PIO0_9/MOSI0/ CT16B0_MAT1/SWO
...
// IOCON.SWCLK_PIO0_10: I/O configuration for pin SWCLK/PIO0_10/ SCK/CT16B0_MAT2
...
// IOCON.PIO2_11: I/O configuration for pin PIO2_11/SCK
...
// IOCON.SCK0_LOC: SCK0 pin location register
func (o *IOCON_Type) SetSCK0_LOC_SCKLOC(value uint32) {
	volatile.StoreUint32(&o.SCK0_LOC.Reg, volatile.LoadUint32(&o.SCK0_LOC.Reg)&^(0x3)|value)
}
func (o *IOCON_Type) GetSCK0_LOC_SCKLOC() uint32 {
	return volatile.LoadUint32(&o.SCK0_LOC.Reg) & 0x3
}
func (o *IOCON_Type) SetSCK0_LOC_RESERVED(value uint32) {
	volatile.StoreUint32(&o.SCK0_LOC.Reg, volatile.LoadUint32(&o.SCK0_LOC.Reg)&^(0xfffffffc)|value<<2)
}
func (o *IOCON_Type) GetSCK0_LOC_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.SCK0_LOC.Reg) & 0xfffffffc) >> 2
}
...
func (o *SYSCON_Type) SetPRESETCTRL_RESERVED(value uint32) {
	volatile.StoreUint32(&o.PRESETCTRL.Reg, volatile.LoadUint32(&o.PRESETCTRL.Reg)&^(0xff800000)|value<<23)
}
func (o *SYSCON_Type) GetPRESETCTRL_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.PRESETCTRL.Reg) & 0xff800000) >> 23
}
...
func (o *SYSCON_Type) SetUSBPLLCTRL_MSEL(value uint32) {
	volatile.StoreUint32(&o.USBPLLCTRL.Reg, volatile.LoadUint32(&o.USBPLLCTRL.Reg)&^(0x1f)|value)
}
func (o *SYSCON_Type) GetUSBPLLCTRL_MSEL() uint32 {
	return volatile.LoadUint32(&o.USBPLLCTRL.Reg) & 0x1f
}
func (o *SYSCON_Type) SetUSBPLLCTRL_PSEL(value uint32) {
	volatile.StoreUint32(&o.USBPLLCTRL.Reg, volatile.LoadUint32(&o.USBPLLCTRL.Reg)&^(0x60)|value<<5)
}
func (o *SYSCON_Type) GetUSBPLLCTRL_PSEL() uint32 {
	return (volatile.LoadUint32(&o.USBPLLCTRL.Reg) & 0x60) >> 5
}
func (o *SYSCON_Type) SetUSBPLLCTRL_RESERVED(value uint32) {
	volatile.StoreUint32(&o.USBPLLCTRL.Reg, volatile.LoadUint32(&o.USBPLLCTRL.Reg)&^(0xffffff80)|value<<7)
}
func (o *SYSCON_Type) GetUSBPLLCTRL_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.USBPLLCTRL.Reg) & 0xffffff80) >> 7
}
...
// SYSCON.SYSRESSTAT: System reset status register
func (o *SYSCON_Type) SetSYSRESSTAT_POR(value uint32) {
	volatile.StoreUint32(&o.SYSRESSTAT.Reg, volatile.LoadUint32(&o.SYSRESSTAT.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetSYSRESSTAT_POR() uint32 {
	return volatile.LoadUint32(&o.SYSRESSTAT.Reg) & 0x1
}
func (o *SYSCON_Type) SetSYSRESSTAT_EXTRST(value uint32) {
	volatile.StoreUint32(&o.SYSRESSTAT.Reg, volatile.LoadUint32(&o.SYSRESSTAT.Reg)&^(0x2)|value<<1)
}
func (o *SYSCON_Type) GetSYSRESSTAT_EXTRST() uint32 {
	return (volatile.LoadUint32(&o.SYSRESSTAT.Reg) & 0x2) >> 1
}
func (o *SYSCON_Type) SetSYSRESSTAT_WDT(value uint32) {
	volatile.StoreUint32(&o.SYSRESSTAT.Reg, volatile.LoadUint32(&o.SYSRESSTAT.Reg)&^(0x4)|value<<2)
}
func (o *SYSCON_Type) GetSYSRESSTAT_WDT() uint32 {
	return (volatile.LoadUint32(&o.SYSRESSTAT.Reg) & 0x4) >> 2
}
func (o *SYSCON_Type) SetSYSRESSTAT_BOD(value uint32) {
	volatile.StoreUint32(&o.SYSRESSTAT.Reg, volatile.LoadUint32(&o.SYSRESSTAT.Reg)&^(0x8)|value<<3)
}
func (o *SYSCON_Type) GetSYSRESSTAT_BOD() uint32 {
	return (volatile.LoadUint32(&o.SYSRESSTAT.Reg) & 0x8) >> 3
}
func (o *SYSCON_Type) SetSYSRESSTAT_SYSRST(value uint32) {
	volatile.StoreUint32(&o.SYSRESSTAT.Reg, volatile.LoadUint32(&o.SYSRESSTAT.Reg)&^(0x10)|value<<4)
}
func (o *SYSCON_Type) GetSYSRESSTAT_SYSRST() uint32 {
	return (volatile.LoadUint32(&o.SYSRESSTAT.Reg) & 0x10) >> 4
}
func (o *SYSCON_Type) SetSYSRESSTAT_RESERVED(value uint32) {
	volatile.StoreUint32(&o.SYSRESSTAT.Reg, volatile.LoadUint32(&o.SYSRESSTAT.Reg)&^(0xffffffe0)|value<<5)
}
func (o *SYSCON_Type) GetSYSRESSTAT_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.SYSRESSTAT.Reg) & 0xffffffe0) >> 5
}
...
// SYSCON.USBPLLCLKUEN: USB PLL clock source update enable
func (o *SYSCON_Type) SetUSBPLLCLKUEN_ENA(value uint32) {
	volatile.StoreUint32(&o.USBPLLCLKUEN.Reg, volatile.LoadUint32(&o.USBPLLCLKUEN.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetUSBPLLCLKUEN_ENA() uint32 {
	return volatile.LoadUint32(&o.USBPLLCLKUEN.Reg) & 0x1
}
func (o *SYSCON_Type) SetUSBPLLCLKUEN_RESERVED(value uint32) {
	volatile.StoreUint32(&o.USBPLLCLKUEN.Reg, volatile.LoadUint32(&o.USBPLLCLKUEN.Reg)&^(0xfffffffe)|value<<1)
}
func (o *SYSCON_Type) GetUSBPLLCLKUEN_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.USBPLLCLKUEN.Reg) & 0xfffffffe) >> 1
}
...
func (o *SYSCON_Type) SetSYSAHBCLKCTRL_SSP(value uint32) {
	volatile.StoreUint32(&o.SYSAHBCLKCTRL.Reg, volatile.LoadUint32(&o.SYSAHBCLKCTRL.Reg)&^(0x800)|value<<11)
}
func (o *SYSCON_Type) GetSYSAHBCLKCTRL_SSP() uint32 {
...
func (o *SYSCON_Type) SetSYSAHBCLKCTRL_USB_REG(value uint32) {
	volatile.StoreUint32(&o.SYSAHBCLKCTRL.Reg, volatile.LoadUint32(&o.SYSAHBCLKCTRL.Reg)&^(0x4000)|value<<14)
}
func (o *SYSCON_Type) GetSYSAHBCLKCTRL_USB_REG() uint32 {
...
// SYSCON.SSP0CLKDIV: SSP clock divder
...
// SYSCON.SSP1CLKDIV: SPISP1 clock divder
...
// SYSCON.SYSTICKCLKDIV: SYSTICK clock divder
...
// SYSCON.USBCLKUEN: USB clock source update enable
func (o *SYSCON_Type) SetUSBCLKUEN_ENA(value uint32) {
	volatile.StoreUint32(&o.USBCLKUEN.Reg, volatile.LoadUint32(&o.USBCLKUEN.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetUSBCLKUEN_ENA() uint32 {
	return volatile.LoadUint32(&o.USBCLKUEN.Reg) & 0x1
}
func (o *SYSCON_Type) SetUSBCLKUEN_RESERVED(value uint32) {
	volatile.StoreUint32(&o.USBCLKUEN.Reg, volatile.LoadUint32(&o.USBCLKUEN.Reg)&^(0xfffffffe)|value<<1)
}
func (o *SYSCON_Type) GetUSBCLKUEN_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.USBCLKUEN.Reg) & 0xfffffffe) >> 1
}

// SYSCON.USBCLKDIV: USB clock source divider
...
func (o *SYSCON_Type) SetPIOPORCAP0_CAPPIO2_0(value uint32) {
	volatile.StoreUint32(&o.PIOPORCAP0.Reg, volatile.LoadUint32(&o.PIOPORCAP0.Reg)&^(0x1000000)|value<<24)
}
func (o *SYSCON_Type) GetPIOPORCAP0_CAPPIO2_0() uint32 {
...
// SYSCON.STARTAPRP0: Start logic edge control register 0; bottom 32 interrupts
...
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_1(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x2000)|value<<13)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_1() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x2000) >> 13
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_2(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x4000)|value<<14)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_2() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x4000) >> 14
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_3(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x8000)|value<<15)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_3() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x8000) >> 15
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_4(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x10000)|value<<16)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_4() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x10000) >> 16
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_5(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x20000)|value<<17)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_5() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x20000) >> 17
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_6(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x40000)|value<<18)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_6() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x40000) >> 18
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_7(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x80000)|value<<19)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_7() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x80000) >> 19
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_8(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x100000)|value<<20)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_8() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x100000) >> 20
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_9(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x200000)|value<<21)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_9() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x200000) >> 21
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_10(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x400000)|value<<22)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_10() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x400000) >> 22
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO1_11(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x800000)|value<<23)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO1_11() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x800000) >> 23
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_0(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x1000000)|value<<24)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_0() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x1000000) >> 24
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_1(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x2000000)|value<<25)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_1() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x2000000) >> 25
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_2(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x4000000)|value<<26)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_2() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x4000000) >> 26
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_3(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x8000000)|value<<27)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_3() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x8000000) >> 27
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_4(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x10000000)|value<<28)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_4() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x10000000) >> 28
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_5(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x20000000)|value<<29)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_5() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x20000000) >> 29
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_6(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x40000000)|value<<30)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_6() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x40000000) >> 30
}
func (o *SYSCON_Type) SetSTARTAPRP0_APRPIO2_7(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP0.Reg, volatile.LoadUint32(&o.STARTAPRP0.Reg)&^(0x80000000)|value<<31)
}
func (o *SYSCON_Type) GetSTARTAPRP0_APRPIO2_7() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP0.Reg) & 0x80000000) >> 31
}

// SYSCON.STARTERP0: Start logic signal enable register 0; bottom 32 interrupts
...
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_1(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x2000)|value<<13)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_1() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x2000) >> 13
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_2(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x4000)|value<<14)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_2() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x4000) >> 14
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_3(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x8000)|value<<15)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_3() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x8000) >> 15
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_4(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x10000)|value<<16)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_4() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x10000) >> 16
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_5(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x20000)|value<<17)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_5() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x20000) >> 17
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_6(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x40000)|value<<18)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_6() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x40000) >> 18
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_7(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x80000)|value<<19)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_7() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x80000) >> 19
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_8(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x100000)|value<<20)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_8() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x100000) >> 20
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_9(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x200000)|value<<21)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_9() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x200000) >> 21
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_10(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x400000)|value<<22)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_10() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x400000) >> 22
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO1_11(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x800000)|value<<23)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO1_11() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x800000) >> 23
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_0(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x1000000)|value<<24)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_0() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x1000000) >> 24
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_1(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x2000000)|value<<25)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_1() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x2000000) >> 25
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_2(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x4000000)|value<<26)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_2() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x4000000) >> 26
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_3(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x8000000)|value<<27)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_3() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x8000000) >> 27
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_4(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x10000000)|value<<28)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_4() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x10000000) >> 28
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_5(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x20000000)|value<<29)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_5() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x20000000) >> 29
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_6(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x40000000)|value<<30)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_6() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x40000000) >> 30
}
func (o *SYSCON_Type) SetSTARTRSRP0CLR_RSRPIO2_7(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP0CLR.Reg, volatile.LoadUint32(&o.STARTRSRP0CLR.Reg)&^(0x80000000)|value<<31)
}
func (o *SYSCON_Type) GetSTARTRSRP0CLR_RSRPIO2_7() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP0CLR.Reg) & 0x80000000) >> 31
}

// SYSCON.STARTSRP0: Start logic status register 0; bottom 32 interrupts
...
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_1(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x2000)|value<<13)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_1() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x2000) >> 13
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_2(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x4000)|value<<14)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_2() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x4000) >> 14
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_3(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x8000)|value<<15)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_3() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x8000) >> 15
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_4(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x10000)|value<<16)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_4() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x10000) >> 16
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_5(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x20000)|value<<17)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_5() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x20000) >> 17
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_6(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x40000)|value<<18)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_6() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x40000) >> 18
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_7(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x80000)|value<<19)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_7() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x80000) >> 19
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_8(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x100000)|value<<20)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_8() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x100000) >> 20
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_9(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x200000)|value<<21)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_9() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x200000) >> 21
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_10(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x400000)|value<<22)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_10() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x400000) >> 22
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO1_11(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x800000)|value<<23)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO1_11() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x800000) >> 23
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_0(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x1000000)|value<<24)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_0() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x1000000) >> 24
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_1(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x2000000)|value<<25)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_1() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x2000000) >> 25
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_2(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x4000000)|value<<26)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_2() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x4000000) >> 26
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_3(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x8000000)|value<<27)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_3() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x8000000) >> 27
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_4(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x10000000)|value<<28)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_4() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x10000000) >> 28
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_5(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x20000000)|value<<29)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_5() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x20000000) >> 29
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_6(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x40000000)|value<<30)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_6() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x40000000) >> 30
}
func (o *SYSCON_Type) SetSTARTSRP0_SRPIO2_7(value uint32) {
	volatile.StoreUint32(&o.STARTSRP0.Reg, volatile.LoadUint32(&o.STARTSRP0.Reg)&^(0x80000000)|value<<31)
}
func (o *SYSCON_Type) GetSTARTSRP0_SRPIO2_7() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP0.Reg) & 0x80000000) >> 31
}

// SYSCON.STARTAPRP1: Start logic edge control register 1; top 8 interrupts
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO2_8(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO2_8() uint32 {
	return volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x1
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO2_9(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x2)|value<<1)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO2_9() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x2) >> 1
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO2_10(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x4)|value<<2)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO2_10() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x4) >> 2
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO2_11(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x8)|value<<3)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO2_11() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x8) >> 3
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO3_0(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x10)|value<<4)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO3_0() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x10) >> 4
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO3_1(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x20)|value<<5)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO3_1() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x20) >> 5
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO3_2(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x40)|value<<6)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO3_2() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x40) >> 6
}
func (o *SYSCON_Type) SetSTARTAPRP1_APRPIO3_3(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0x80)|value<<7)
}
func (o *SYSCON_Type) GetSTARTAPRP1_APRPIO3_3() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0x80) >> 7
}
func (o *SYSCON_Type) SetSTARTAPRP1_RESERVED(value uint32) {
	volatile.StoreUint32(&o.STARTAPRP1.Reg, volatile.LoadUint32(&o.STARTAPRP1.Reg)&^(0xffffff00)|value<<8)
}
func (o *SYSCON_Type) GetSTARTAPRP1_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.STARTAPRP1.Reg) & 0xffffff00) >> 8
}

// SYSCON.STARTERP1: Start logic signal enable register 1; top 8 interrupts
func (o *SYSCON_Type) SetSTARTERP1_ERPIO2_8(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO2_8() uint32 {
	return volatile.LoadUint32(&o.STARTERP1.Reg) & 0x1
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO2_9(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x2)|value<<1)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO2_9() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x2) >> 1
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO2_10(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x4)|value<<2)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO2_10() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x4) >> 2
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO2_11(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x8)|value<<3)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO2_11() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x8) >> 3
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO3_0(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x10)|value<<4)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO3_0() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x10) >> 4
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO3_1(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x20)|value<<5)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO3_1() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x20) >> 5
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO3_2(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x40)|value<<6)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO3_2() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x40) >> 6
}
func (o *SYSCON_Type) SetSTARTERP1_ERPIO3_3(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0x80)|value<<7)
}
func (o *SYSCON_Type) GetSTARTERP1_ERPIO3_3() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0x80) >> 7
}
func (o *SYSCON_Type) SetSTARTERP1_RESERVED(value uint32) {
	volatile.StoreUint32(&o.STARTERP1.Reg, volatile.LoadUint32(&o.STARTERP1.Reg)&^(0xffffff00)|value<<8)
}
func (o *SYSCON_Type) GetSTARTERP1_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.STARTERP1.Reg) & 0xffffff00) >> 8
}

// SYSCON.STARTRSRP1CLR: Start logic reset register 1; top 8 interrupts
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO2_8(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO2_8() uint32 {
	return volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x1
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO2_9(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x2)|value<<1)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO2_9() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x2) >> 1
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO2_10(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x4)|value<<2)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO2_10() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x4) >> 2
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO2_11(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x8)|value<<3)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO2_11() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x8) >> 3
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO3_0(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x10)|value<<4)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO3_0() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x10) >> 4
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO3_1(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x20)|value<<5)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO3_1() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x20) >> 5
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO3_2(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x40)|value<<6)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO3_2() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x40) >> 6
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RSRPIO3_3(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0x80)|value<<7)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RSRPIO3_3() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0x80) >> 7
}
func (o *SYSCON_Type) SetSTARTRSRP1CLR_RESERVED(value uint32) {
	volatile.StoreUint32(&o.STARTRSRP1CLR.Reg, volatile.LoadUint32(&o.STARTRSRP1CLR.Reg)&^(0xffffff00)|value<<8)
}
func (o *SYSCON_Type) GetSTARTRSRP1CLR_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.STARTRSRP1CLR.Reg) & 0xffffff00) >> 8
}

// SYSCON.STARTSRP1: Start logic status register 1; top 8 interrupts
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO2_8(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x1)|value)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO2_8() uint32 {
	return volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x1
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO2_9(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x2)|value<<1)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO2_9() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x2) >> 1
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO2_10(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x4)|value<<2)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO2_10() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x4) >> 2
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO2_11(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x8)|value<<3)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO2_11() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x8) >> 3
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO3_0(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x10)|value<<4)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO3_0() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x10) >> 4
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO3_1(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x20)|value<<5)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO3_1() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x20) >> 5
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO3_2(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x40)|value<<6)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO3_2() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x40) >> 6
}
func (o *SYSCON_Type) SetSTARTSRP1_SRPIO3_3(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0x80)|value<<7)
}
func (o *SYSCON_Type) GetSTARTSRP1_SRPIO3_3() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0x80) >> 7
}
func (o *SYSCON_Type) SetSTARTSRP1_RESERVED(value uint32) {
	volatile.StoreUint32(&o.STARTSRP1.Reg, volatile.LoadUint32(&o.STARTSRP1.Reg)&^(0xffffff00)|value<<8)
}
func (o *SYSCON_Type) GetSTARTSRP1_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.STARTSRP1.Reg) & 0xffffff00) >> 8
}

// SYSCON.PDSLEEPCFG: Power-down states in Deep-sleep mode
func (o *SYSCON_Type) SetPDSLEEPCFG_FIXEDVAL0(value uint32) {
	volatile.StoreUint32(&o.PDSLEEPCFG.Reg, volatile.LoadUint32(&o.PDSLEEPCFG.Reg)&^(0x7)|value)
}
func (o *SYSCON_Type) GetPDSLEEPCFG_FIXEDVAL0() uint32 {
...
func (o *SYSCON_Type) SetPDSLEEPCFG_FIXEDVAL1(value uint32) {
	volatile.StoreUint32(&o.PDSLEEPCFG.Reg, volatile.LoadUint32(&o.PDSLEEPCFG.Reg)&^(0x30)|value<<4)
}
func (o *SYSCON_Type) GetPDSLEEPCFG_FIXEDVAL1() uint32 {
...
func (o *SYSCON_Type) SetPDSLEEPCFG_FIXEDVAL2(value uint32) {
	volatile.StoreUint32(&o.PDSLEEPCFG.Reg, volatile.LoadUint32(&o.PDSLEEPCFG.Reg)&^(0xf80)|value<<7)
}
func (o *SYSCON_Type) GetPDSLEEPCFG_FIXEDVAL2() uint32 {
	return (volatile.LoadUint32(&o.PDSLEEPCFG.Reg) & 0xf80) >> 7
}
func (o *SYSCON_Type) SetPDSLEEPCFG_RESERVED(value uint32) {
	volatile.StoreUint32(&o.PDSLEEPCFG.Reg, volatile.LoadUint32(&o.PDSLEEPCFG.Reg)&^(0xfffff000)|value<<12)
}
func (o *SYSCON_Type) GetPDSLEEPCFG_RESERVED() uint32 {
	return (volatile.LoadUint32(&o.PDSLEEPCFG.Reg) & 0xfffff000) >> 12
}
...
// Constants for I2C: Product name title=UM10375 Chapter title=LPC13xx I2C-bus controller Modification date=4/19/2011 Major revision=2 Minor revision=1
const (
...
// Constants for WWDT: Product name title=UM10375 Chapter title=LPC13xx Windowed WatchDog Timer (WWDT) Modification date=4/19/2011 Major revision=2 Minor revision=1
const (
...
// Constants for UART: Product name title=UM10375 Chapter title=LPC13xx UART Modification date=4/19/2011 Major revision=2 Minor revision=1
const (
...
// Constants for CT16B0: Product name title=UM10375 Chapter title=LPC13xx 16-bit timer/counters (CT16B0/1) Modification date=4/19/2011 Major revision=2 Minor revision=1
const (
...
// Constants for CT32B0: Product name title=UM10375 Chapter title=LPC13xx 32-bit timer/counters (CT32B0/1) Modification date=4/19/2011 Major revision=2 Minor revision=1
const (
	// BIR: Interrupt Register (IR). The IR can be written to clear interrupts. The IR can be read to identify which of five possible interrupt sources are pending.
	// Position of MR0INT field.
...
// Constants for ADC: Product name title=UM10375 Chapter title=LPC13xx Analog-to-Digital Converter (ADC) Modification date=4/19/2011 Major revision=2 Minor revision=1
const (
...
// Constants for USB: Product name title=UM10375 Chapter title=LPC13xx USB device controller Modification date=4/20/2011 Major revision=2 Minor revision=1
const (
...
// Constants for PMU: Product name title=UM10375 Chapter title=LPC13xx Power Management Unit (PMU) Modification date=4/20/2011 Major revision=2 Minor revision=1
const (
...
// Constants for FMC: Product name title=UM10375 Chapter title=LPC13xx Flash memory programming firmware Modification date=4/20/2011 Major revision=2 Minor revision=1
const (
...
// Constants for SSP0: Product name title=UM10375 Chapter title=LPC13xx SSP0/1 Modification date=4/20/2011 Major revision=2 Minor revision=1
const (
...
// Constants for IOCON: Product name title=UM10375 Chapter title=LPC13xx I/O configuration Modification date=4/20/2011 Major revision=2 Minor revision=1
const (
...
// Constants for SYSCON: Product name title=UM10375 Chapter title=LPC13xx System configuration Modification date=4/4/2011 Major revision=2 Minor revision=2
const (
...
// Constants for GPIO0: Product name title=UM10375 Chapter title=LPC13xx General Purpose I/O (GPIO) Modification date=4/20/2011 Major revision=2 Minor revision=1
const (
